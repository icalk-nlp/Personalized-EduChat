...
from langchain.document_loaders import (
    ...
    UnstructuredWordDocumentLoader, PDFMinerLoader, PyPDFLoader,
)
from langchain.text_splitter import CharacterTextSplitter
from tqdm import tqdm

from utils.pdf_utils.FormattedPdf import FormattedPdf
...
def read_data(data_path: Path):
    ...
    if '.xlsx' == suffix:
        ...
        data = FormattedPdf(str(data_path)).get_langchain_documents()
    else:
